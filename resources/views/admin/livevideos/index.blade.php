        ...
        <div class="modal-dialog modal-warning">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="/live-videos/list">
    ...
    <script>
        $(function () {
            var table = $("#tags-table").DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        'targets': 2,
                        "render": function (data, type, row) {
                            return "<a href='/admin/live-videos/"+data+"'>查看视频</a>";
                        }
                    },
                    {
                        'targets': -1, "render": function (data, type, row) {
                            ...
                            //编辑
                            if (row_edit) {
                                str += '<a style="margin:3px;" href="/admin/live-videos/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                            }
                            //删除
                            if (row_delete) {
            ...
            $("table").delegate('.delBtn', 'click', function () {
                ...
                $('.deleteForm').attr('action', '/admin/live-videos/' + id);
                $("#modal-delete").modal();
            });
        });
    </script>
