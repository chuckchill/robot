        ...
        <div class="modal-dialog modal-warning">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="/startup-page/list">
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                'targets': -1, "render": function (data, type, row) {
                                    ...
                                    //编辑
                                    if (row_edit) {
                                        str += '<a style="margin:3px;" href="/admin/startup-page/' + row['id'] + '/edit" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 编辑</a>';
                                    }
                                    //删除
                                    if (row_delete) {
