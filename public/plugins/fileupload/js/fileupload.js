        ...
        constructor: i, _cleanup: function () {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, B = u + "-" + U, O = i[x], R = m.text, L = m.image,
                    Z = m.html, M = O && O.name ? r.slug(O.name) : "", N = (O && O.size || 0) / 1e3, H = "",
                    V = O ? t.objUrl.createObjectURL(O) : null, W = 0, q = "", K = 0, G = function () {
                        var e = p.setTokens({index: x + 1, files: f, percent: 50, name: M});
                        setTimeout(function () {
                ...
                if (O) {
                    ...
                    if (0 === M.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(O.name)), void y(S, O, B, x);
                    ...
                    if (!t.isEmpty(g) && t.isArray(g)) {
                        ...
                        if (0 === W) return S = r.msgInvalidFileType.setTokens({name: M, types: q}), void y(S, O, B, x)
                    }
                    ...
                    if (!r.showPreview) return r.isAjaxUpload && r.addToStack(O), setTimeout(function () {
                        a(x + 1), r._updateFileDetails(f)
                    }, 100), void r._raise("fileloaded", [O, B, x, l]);
                    if (!C && N > b) return r.addToStack(O), s.addClass("file-thumb-loading"), r._previewDefault(O, B), r._initFileActions(), r._updateFileDetails(f), void a(x + 1);
                    o.length && void 0 !== FileReader ? (D = R(O.type, M), z = Z(O.type, M), $ = L(O.type, M), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                        ...
                        var a, n, o, s, d, c, p = [], u = function (e) {
                            ...
                            t.onerror = function (e) {
                                ...
                                r._previewFile(x, O, e, B, V, n), r._initFileActions(), G()
                            }, e ? t.readAsText(O, r.textEncoding) : t.readAsDataURL(O)
                        };
                        if (n = {name: M, type: O.type}, e.each(m, function (e, t) {
